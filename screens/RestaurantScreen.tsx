...
import { UserIcon, ChevronDownIcon, QuestionMarkCircleIcon } from 'react-native-heroicons/outline'
import { TouchableOpacity } from 'react-native'
import { ArrowLeftIcon, ArrowLongLeftIcon, ChevronRightIcon, MapPinIcon, StarIcon } from 'react-native-heroicons/solid'
    ...
    <View className="relative">
      ...
      >
        <View className="w-10 h-10 bg-white items-center justify-center rounded-3xl border">
          <ArrowLongLeftIcon color="black" size={20} />
        </View>
      </TouchableOpacity>
          ...
          <View className='px-4 pt-3'>
            ...
            <View className='flex-row space-x-2 my-1'>
              <View className='flex-row items-center space-x-2'>
                ...
                <Text className='text-green-600 text-s'>{rating}</Text>
